...
export default function Home() {
  ...
  return (
    <div className="bg-gradient-to-tr from-bgDark to-bgLight ">
      <Header />
      <div className="flex justify-center h-full items-center" id="section-video">
        <iframe
          ...
          className="h-[600px] w-[300px] tablet:h-[360px] tablet:w-[720px] macair:w-[1240px] macair:h-[720px] desktop:h-[720px] desktop:w-[1440px] rounded-md "
